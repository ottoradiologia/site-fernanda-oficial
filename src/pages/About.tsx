          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              <img 
                ...
                alt="Dra. Fernanda Kruger - Pediatra e mãe, especialista em saúde infantil no Paraíso SP" 
            ...
            <div className="space-y-6">
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-600 leading-relaxed mb-4">
                  {t.pages.about.content.paragraph1}
                </p>
                <p className="text-gray-600 leading-relaxed mb-4">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  <span className="font-bold text-[#fdb4be]">{t.pages.about.content.paragraph5}</span>
                </p>
                <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-4">
                  {t.pages.about.qualifications.items.map((qualification, index) => (
